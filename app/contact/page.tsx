          ...
          <div className="bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-[#5D4037]">Email</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-[#5D4037]">Follow Us</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-[#5D4037]">FAQ</h3>
                  <p className="mt-1 text-gray-600">
                    Check our <a href="/faq" className="text-[#FF5722] hover:underline">FAQ page</a> for answers to common questions.
                  </p>
                </div>
              </div>
            </div>
